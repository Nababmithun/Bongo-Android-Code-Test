...
import com.movieplayer.base_mvvp.ui.adapter.MovieTrailersAdapter
import com.movieplayer.base_mvvp.utils.Constants.Keys.IntentKeys
import com.movieplayer.base_mvvp.utils.DateUtils
...
class MovieDetailsActivity : BaseActivity<MovieDetailsViewModel>() {
    ...
    override fun onViewReady(savedInstanceState: Bundle?, intent: Intent) {
        ...
        if (bundle != null) {
            ...
            mViewModel.getMovieDetails(movieId, apiKey)
            mViewModel.getMovieTrailers(movieId, apiKey)
        }
    }
